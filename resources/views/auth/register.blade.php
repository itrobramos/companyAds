                        ...
                        <div class="p-5">
                            ...
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0"><input class="form-control form-control-user @error('name') is-invalid @enderror"
                                            type="text" id="exampleFirstName" placeholder="First Name"
                                            name="name"></div>
                                    <div class="col-sm-6"><input class="form-control form-control-user @error('name') is-invalid @enderror" type="text"
                                ...
                                <div class="form-group">
                                    <input class="form-control form-control-user @error('email') is-invalid @enderror" type="email" id="exampleInputEmail"
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0"><input class="form-control form-control-user @error('password') is-invalid @enderror"
