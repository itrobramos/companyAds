        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0">
                <a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                    ...
                    <div class="sidebar-brand-text mx-3"><span>VR</span></div>
                </a>
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link" href="{{url('categories')}}"><i class="fas fa-table"></i><span>Mi Negocio</span></a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link" href="{{url('subcategories')}}"><i class="fas fa-table"></i><span>Mis Productos / Servicios</span></a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link" href="{{url('companies')}}"><i class="fas fa-table"></i><span>Mis Promociones</span></a></li>
                </ul>
